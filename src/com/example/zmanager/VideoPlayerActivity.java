...
public class VideoPlayerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dialog2 = ProgressDialog.show(this, "提示", "正在加载中");  
		new Thread(new Runnable() {

			@Override
			public void run() {
				if (playList.size() == 0) {
					LinkedList<MovieInfo> playList1 = getVideoFile(playList, new File("/sdcard/"));
					playList = playList1;
				}		
		...
		Cursor cursor = getContentResolver().query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, new String[]{"_display_name","_data"}, null, null, null);
...
//		playList.clear();
	...
	private LinkedList<MovieInfo> getVideoFile(final LinkedList<MovieInfo> list,File file){
